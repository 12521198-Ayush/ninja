...
class Client extends Model
{
    ...
    protected $fillable = [
        'ai_secret_key', 'company_name', 'logo', 'timezone', 'slug', 'country_id', 'address', 'status', 'webhook_verify_token', 'api_key', 'stripe_customer_id', 'paddle_customer_id', 'big_commerce_status', 'webhook_url', 'webhook_enabled', 'webhook_secret',
    ];
