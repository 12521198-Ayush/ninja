								...
								<form id="filterForm">
									<div class="row align-items-center">
										...
										<div class="col-lg-10 text-end">
											<div class="mb-3">
												<a href="{{ route('client.whatsapp.campaigns.export-logs', ['id' => $campaign->id]) }}" 
												   id="downloadCsvBtn"
												   class="btn sg-btn-primary">
													<i class="las la-download"></i> {{ __('Download CSV') }}
												</a>
											</div>
										</div>
									</div>
...
@push('js')
	<script>
        $(document).ready(function () {
            const baseExportUrl = "{{ route('client.whatsapp.campaigns.export-logs', ['id' => $campaign->id]) }}";
