...
Route::group(['prefix' => localeRoutePrefix().'/client', 'middleware' => 'subscriptionCheck'], function () {
    ...
    // Webhook Settings
    Route::get('webhook-settings', [ClientSettingController::class, 'webhookSettings'])->name('webhook.settings');
    Route::post('webhook-settings/update', [ClientSettingController::class, 'webhookSettingsUpdate'])->name('webhook.settings.update');
    Route::post('webhook-settings/test', [ClientSettingController::class, 'webhookSettingsTest'])->name('webhook.settings.test');
    // Billing Routes
    ...
    Route::middleware(['whatsapp.connected'])->group(function () {
        ...
        Route::get('whatsapp/campaigns/{id}/export-logs', [WhatsappCampaignController::class, 'exportLogs'])->name('whatsapp.campaigns.export-logs');
        ...
        Route::post('whatsapp/campaign/quick-contact-group', [WhatsappCampaignController::class, 'quickContactGroup'])->name('whatsapp.campaign.quick-contact-group');
    });
    ...
    Route::get('quick-contacts-sample', [ContactsListController::class, 'downloadQuickSample'])->name('contacts.quick-sample');
...
// Route::get('/check-emiro-config', function () {
//     $path = base_path('app/Addons/EmiroSync/config.json');
