...
Route::group(['prefix' => localeRoutePrefix() . '/api'], function () {
    // Wallet routes
    Route::get('/wallet/get-balance/{id}', [\App\Http\Controllers\Api\WalletController::class, 'getBalance']);
    Route::post('/users/{id}/increment-balance', [\App\Http\Controllers\Api\WalletController::class, 'incrementBalance']);
    Route::post('/users/{id}/decrement-balance', [\App\Http\Controllers\Api\WalletController::class, 'decrementBalance']);
    Route::get('{id}/balance-history', [\App\Http\Controllers\Api\BalanceHistoryController::class, 'index']);

    Route::post('/users/{user}/update-prices', [\App\Http\Controllers\Api\UserPriceController::class, 'updatePrices']);
    Route::get('/users/{user}/get-prices', [\App\Http\Controllers\Api\UserPriceController::class, 'getPrices']);
